...
You can find more detailed documentation about the code involved in this workshop here (link coming SoonTM), 
...
Refs need formatting. Should be: Noord, Cas, Jiminez, GIPSY, and DataThief.