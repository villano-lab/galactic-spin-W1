...
data_disk = dp.getXYdata('data/NGC5533/noord-120kpc-disk.txt')
data_halo = dp.getXYdata('data/NGC5533/noord-120kpc-halo.txt')
data_gas = dp.getXYdata('data/NGC5533/noord-120kpc-gas.txt')
