...
If you decide to use this code, or if you want to add a reference to it, please cite the latest archived version,
    ...
    Villano, A.N., Bergfalk, J., Hatami, R., Harris, K., Vititoe, F., and Johnston, J., 2023, The Data Behind Dark Matter: Exploring Galactic Rotation [Code, v3.0.3] [DOI:10.5281/zenodo.6588350]
